...
import { Sparkles, ArrowLeft, Eye, EyeOff, Check, Github } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <Card className="border border-gray-200 shadow-2xl bg-white/90 backdrop-blur-sm">
          <CardHeader className="space-y-1 pb-8">
            ...
            <CardDescription className="text-center text-gray-600 text-lg">
              Start creating beautiful diagrams in minutes. Join thousands of creative teams.
            </CardDescription>
          </CardHeader>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-start space-x-3">
                <label htmlFor="terms" className="text-sm text-gray-600 leading-relaxed">
                  I agree to the{' '}
                  <Link href="#" className="text-blue-600 hover:text-blue-700 transition-colors font-medium underline">
                    Terms of Service
                  </Link>{' '}
                  and{' '}
                  <Link href="#" className="text-blue-600 hover:text-blue-700 transition-colors font-medium underline">
              ...
              <Button 
                type="submit" 
                disabled={!acceptTerms || !allRequirementsMet || isLoading}
                className="w-full h-12 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none font-semibold text-base"
              >
                {isLoading ? (
        ...
        <div className="mt-8 text-center text-xs text-gray-500">
          ...
          <Link href="#" className="hover:text-gray-700 transition-colors underline">Terms of Service</Link> and{' '}
          <Link href="#" className="hover:text-gray-700 transition-colors underline">Privacy Policy</Link>
        </div>
      </div>
    </div>
  );
